...
class GXSettings extends javax.swing.JDialog implements ActionListener {
    ...
    GXSettings(final java.awt.Frame parent, final boolean modal,
        ...
        this.intervalTB.setText(String.valueOf(target.getSMSCheckInterval()));
    }
    ...
    private void initComponents() {
        ...
        PhoneNumberPanelLayout.setHorizontalGroup(PhoneNumberPanelLayout
                ...
                .addGroup(PhoneNumberPanelLayout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18).addComponent(phoneNumberTB)
                        .addContainerGap()));
        ...
        intervalPanel.setPreferredSize(new java.awt.Dimension(298, 35));

        intervalLbl.setText("Check Interval:");

        javax.swing.GroupLayout IntervalPanelLayout =
                new javax.swing.GroupLayout(intervalPanel);
        ...
        IntervalPanelLayout.setHorizontalGroup(IntervalPanelLayout
                ...
                .addGroup(IntervalPanelLayout.createSequentialGroup()
                        .addContainerGap().addComponent(intervalLbl)
                        .addGap(18, 18, 18)
                        .addComponent(intervalTB,
        ...
        IntervalPanelLayout.setVerticalGroup(IntervalPanelLayout
                .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING,
                        IntervalPanelLayout.createSequentialGroup()
                                .addContainerGap(
                                        javax.swing.GroupLayout.DEFAULT_SIZE,
                                        Short.MAX_VALUE)
                                .addGroup(IntervalPanelLayout
                                        .createParallelGroup(
                                                javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void okBtnActionPerformed(final ActionEvent evt) {
        try {
            ...
            target.setSMSCheckInterval(
                    Integer.parseInt(this.intervalTB.getText()));
            accepted = true;
            this.dispose();
        } catch (Exception ex) {
